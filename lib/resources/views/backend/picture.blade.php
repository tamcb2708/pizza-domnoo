                            ...
                            ?>
                                                              ...
                                                              <form method="post" action="{{asset('admin/product/save-picture/'.$item->pr_id)}}">
                                                                  <div class="form-group">
                                                                    ...
                                                                    <img  id="anhSanPham" class="thubnail" width="20%;" height="20%;"  src="{{asset('public/Backend/SanPham/'.$item->im_img1)}}">
                                                                    <hr>
                                                                    <label >Ảnh Sản Phẩm 2</label>
                                                                    <input required id="img" type="file"   name="img" class="form-control hidden" onchange="changeImg(this)">
                                                                    <img  id="anhSanPham" class="thubnail" width="20%;" height="20%;"  src="{{asset('public/Backend/SanPham/'.$item->im_img2)}}">
                                                                    <hr>
                                                                    <label >Ảnh Sản Phẩm 3</label>
                                                                    <input required id="img" type="file"   name="img" class="form-control hidden" onchange="changeImg(this)">
                                                                    <img  id="anhSanPham" class="thubnail" width="20%;" height="20%;"  src="{{asset('public/Backend/SanPham/'.$item->im_img3)}}">
                                                                    <hr>
                                                                    <label >Ảnh Sản Phẩm 4</label>
                                                                    <input required id="img" type="file"   name="img" class="form-control hidden" onchange="changeImg(this)">
                                                                    <img  id="anhSanPham" class="thubnail" width="20%;" height="20%;"  src="{{asset('public/Backend/SanPham/'.$item->im_img4)}}">
                                                                    <hr>
                                                                    <label >Ảnh Sản Phẩm 5</label>
                                                                    <input required id="img" type="file"   name="img" class="form-control hidden" onchange="changeImg(this)">
                                                                    <img  id="anhSanPham" class="thubnail" width="20%;" height="20%;"  src="{{asset('public/Backend/SanPham/'.$item->im_img5)}}">
                                                                    <hr>
                                                                    @endforeach
                                                                  </div>
                                                                   <div class="form-group">
