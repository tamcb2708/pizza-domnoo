                            ...
                            <table class="table table-striped b-t b-light">
                               ...
                               <tbody>
                                  @foreach($catelist as $cate)
                                   ...
                                   <td>
                                       <a href="{{asset('admin/cate/edit/'.$cate->ca_id)}}" class="btn btn-warning">
                                           <span class="glyphicon glyphicon-edit"></span>
                                           Sửa Danh Mục
                                       </a>
                                       <a href="{{asset('admin/cate/delete/'.$cate->ca_id)}}" onclick="return confirm('Bạn chắc chắn muốn xóa  ?')" class="btn btn-danger"> <span class="glyphicon glyphicon-edit"></span> Xóa Danh Mục</a>
                                   </td>
                                   </tr>
                                 @endforeach
                               </tbody>          
