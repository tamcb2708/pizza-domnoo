...
<section class="page-info new-block">
    ...
    <div class="container">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active"><a href="{{asset('/nguoi-dung/thanh-toan.html')}}">Thanh Toán</a></li>
        </ol>
    </div>
</section><!-- banner -->
        <div class="container">
                ...
                <form  method="POST">
                    ...
                    <div style="height: 100px; width:100%" class="col-lg-12 col-md-12">
                        ...
                        <div style="height: 100px" class="form-group">
                            <input type="text" readonly name="" value="Chọn Địa Chỉ Nhận Hàng( Bắt Buộc)" class="form-control">
                        </div>	
                    </div>
                    <div style="height: 100px; width:100%" class="col-lg-12 col-md-12">
                        <h2 style="background-color: antiquewhite">Chọn Thành Phố</h2>
                        <div style="height: 100px" class="form-group">
                            <select style="height: 50px; width:100%" name="city" id="city" class="form-control input-sm m-bot15 choose city" >
                                <option value=""></option>
                                    @foreach($city as $ci)
                    ...
                    <div style="height: 100px; width:100%" class="col-lg-12 col-md-12">
                        <h2 style="background-color: antiquewhite">Chọn Địa Chỉ</h2>
                        <div style="height: 100px" class="form-group">
                            <select style="height: 50px; width:100%" name="province" id="province" class="form-control input-sm m-bot15 province choose" >
                                <option value=""></option>    
                            </select>
                        </div>	
                    </div>
                     <div style="height: 100px; width:100%" class="col-lg-12 col-md-12">
                        <h2 style="background-color: antiquewhite">Chọn</h2>
                        <div style="height: 100px" class="form-group">
                            <select style="height: 50px; width:100%" name="wards" id="wards" class="form-control input-sm m-bot15  wards" >
                                <option value=""></option>
                            </select>
                        </div>	
                    </div>
                    ...
                    <div class="col-lg-12 col-md-12 text-center">
                        <input type="button" value="Tính Phí Vận Chuyển" name="calculate_order" id="btn" class="calculate_delivery btn btn3" style="color: aliceblue">
                    </div>
                    @csrf
                </form>
                <form >
                    ...
                    @csrf
                    <div style="height: 100px; width:100%" class="col-lg-12 col-md-12">
                        <h2 style="background-color: antiquewhite">Điền tên người nhận</h2>
                        <div style="height: 100px" class="form-group">
                            <input style="height: 50px; width:100%" type="text" value="{{old('name')}}" name="shipping_name" placeholder="Họ và tên Người Nhận" class="shipping_name form-control">
                        </div>	
                    </div>
                    <div style="height: 100px; width:100%" class="col-lg-12 col-md-12">
                        <h2 style="background-color: antiquewhite">Địa chỉ nhận hàng</h2>
                        <div style="height: 100px" class="form-group">
                            <input style="height: 50px; width:100%" type="text" value="{{old('address')}}" name="shipping_address" placeholder="Địa Chỉ Nhận Hàng" class="shipping_address form-control">
                        </div>	
                    </div>
                    <div style="height: 100px; width:100%" class="col-lg-12 col-md-12">
                        <h2 style="background-color: antiquewhite">Điện Thoại</h2>
                        <div style="height: 100px" class="form-group">
                            <input style="height: 50px; width:100%" type="text" value="{{old('phone')}}" name="shipping_phone" placeholder="Điện Thoại Người Nhận" class="shipping_phone form-control">
                        </div>	
                    </div>
                    <div style="height: 100px; width:100%" class="col-lg-12 col-md-12">
                        <h2 style="background-color: antiquewhite">Ghi Chú</h2>
                        <div style="height: 100px" class="form-group">
                            <textarea style="height: 80%; width:100%"  placeholder="lưu ý cho người giao hàng"  name="shipping_note" class="shipping_note form-control">
                            </textarea>
                        </div>	
                    </div> 
                    <div style="height: 100px; width:100%" class="col-lg-12 col-md-12">
                        <h2 style="background-color: antiquewhite">Giá Giao Hàng( bắt buộc)</h2>
                        <div class="form-group" style="height: 100px">
                            @if(Session::get('free'))
                                <input type="text" readonly name="order_free" class="form-control order_free" value="{{Session::get('free')}}">
                            @else
                                <input type="text" readonly name="" value="Tính Phí Ship Để Xem Giá Ship của Ban" class="form-control">
                            @endif   
                            ...
                            @endforeach
                            @else
                            <input type="hidden" name="order_coupon" class="order_coupon" value="khong co coupon">
                            @endif
                        </div>
                    </div>
                    <hr>
                    <div style="height: 100px; width:100%" class="col-lg-12 col-md-12">
                        <h2 style="background-color: antiquewhite">Chọn Phương Thức Thanh Toán</h2>
                        <div style="height: 100px" class="form-group">
                    ...
                    <hr>
                    <div class="col-lg-12 col-md-12 text-center">
                        <input type="button"  class="send_order_detail btn btn3" name="send_order"  value="Gửi Đơn Hàng" style="color: aliceblue">
                    </div>
                </form>               
            </div>
            <hr>
                ...
                <table class="table cart-tbl">
                    ...
                    <tbody>
                     ...
                     @endphp
                        <tr>
                            <td class="p_dtl">
                                <img style="height: 60px; width:60px;" src="{{asset('public/Backend/SanPham/'.$cart['product_img'])}}" alt="" class="img-responsive">
                                <p>{{$cart['product_name']}}</p>
                                <span style="font-size: 10px" class="ab-txt-block">	@if($cart['product_size']==1)
                                    Cỡ 12 inch
                     ...
                     @endif</span>
                            ...
                            <td><p style="color: rgb(196, 112, 11)"> x {{$cart['product_qty']}}</p></td>
                            <td class="p_ttl">
            ...
            {{-- <div class="col-md-7">
                <hr>
                <div class="title">
                    <p class="top-h">Bảng Giá Tính Phí Ship</p>
                </div>
            </div> --}}
            <div class="col-md-5">
            ...
            echo number_format($total_after,0,',','.').'VND';
                    ...
                    <div class="block-stl10">
                        ...
                        <form action="{{asset('cart/check-coupon')}}" method="POST">
                            ...
                            <hr>
                            @if(Session::get('free'))
                            <a style="background-color: red" href="{{asset('nguoi-dung/delete-free')}}" class="btn1 stl3">Xóa Phí Vận Chuyển</a>
                            @endif
                        </form>
                    </div>
                </div>
