                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form  method="POST" action="{{asset('admin/register')}}">
                                @csrf
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" name="phone" value="{{old('phone')}}" id="exampleInputEmail"
                                        placeholder="Phone">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" name="name" value="{{old('name')}}" id="exampleInputEmail"
                                        placeholder="Name">
                                </div>
                                ...
                                <input type="submit" name="submit" class="btn btn-primary btn-user btn-block" value="Đăng Ký">
                                <hr>
