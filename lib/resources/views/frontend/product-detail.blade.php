				...
				<div class="row">
					<div class="col-lg-6 col-md-6">
						<div style="height: 450px; width: 521px;"class="img-holder">
							<img style="height: 450px; width: 521px;" src="{{asset('public/Backend/SanPham/'.$item->pr_img)}}" alt="" class="img-responsive">
						</div>
					</div>
					<div class="col-lg-6 col-md-6">
						<div class="block-stl6">
							...
							<p class="ab-txt">Thành Phần:{!!$item->pr_element!!}</p>
							<hr>
								...
								<div class="item">
									<div class="block-stl8">
										<div class="img-holder">
											<img src="images/r_img1.png" alt="" class="img-responsive"> 
										</div>
										<div class="txt-block">
											<i class="flaticon-left-quote"></i>
											<p>Lorem ipsum dolor sit amet consectetur adipiscing elit. Curabitur erat turpis posuere ac ante at</p>
