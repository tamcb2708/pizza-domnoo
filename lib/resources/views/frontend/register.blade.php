                        ...
                        <form action="{{ asset('/nguoi-dung/dang-ky-tai-khoan.html') }}" method="POST">
                            ...
                            <div style="height: 100px; width:100%" class="col-lg-12 col-md-12">
                                ...
                                <div style="height: 100px" class="form-group">
                                    <input style="height: 50px; width:100%" type="text" value="{{ old('name') }}"
                            ...
                            <div style="height: 100px; width:100%" class="col-lg-12 col-md-12">
                                ...
                                <div style="height: 100px" class="form-group">
                                    <input style="height: 50px; width:100%" type="text" value="{{ old('address') }}"
                            ...
                            <div style="height: 100px; width:100%" class="col-lg-12 col-md-12">
                                ...
                                <div style="height: 100px" class="form-group">
                                    <input style="height: 50px; width:100%" type="text" value="{{ old('phone') }}"
                                        name="phone" placeholder="Số Điện Thoại" class="form-control">
                                </div>
                            </div>
                            ...
                            <hr>
                            <div class="col-lg-12 col-md-12 g-recaptcha" data-sitekey="{{ env('CAPTCHA_KEY') }}"></div>
                            <br />
                            @if ($errors->has('g-recaptcha-response'))
                                <span class="col-lg-12 col-md-12 invalid-feedback" style="display:block">
                                    <strong>{{ $errors->first('g-recaptcha-response') }}</strong>
                                </span>
                            @endif
							<hr>
                            <div class="col-lg-12 col-md-12 text-center">
                                <input type="submit" id="btn" class="btn btn3" value="Đăng Ký"
                                    style="color: aliceblue">
                            </div>
                            <a style="background-color: darkgrey" class="btn btn3"
                                href="{{ asset('/nguoi-dung/dang-nhap.html') }}">Bạn Đã Có Tài Khoản ?</a>
                        </form>
                    </div>
                </div>
            </div>
