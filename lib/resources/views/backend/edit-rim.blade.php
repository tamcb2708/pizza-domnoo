                            ...
                            ?>
                                                              ...
                                                              <form method="post" action="{{asset('admin/rim/update-rim/'.$item->ri_id)}}">
                                                                  <div class="form-group">
                                                                      ...
                                                                      <input required type="text"  name="name" class="form-control" readonly placeholder="Điền Thông Tin..." value="{{$item->ri_name}}">
                                                                      <hr>
                                    
                                                                      <label >Giá</label>
                                                                      <input required type="text"  name="price" class="form-control" placeholder="Điền Thông Tin..." value="{{$item->ri_price}}">
                                                                      <hr>
                                                                      <hr>
                                                                   ...
                                                                   <div class="form-group">
                                                                      <a href="{{asset('admin/rim')}}" class="form-control btn btn-danger">Quay Về Trang Trước</a>
                                                                  </div>
                                                                  {{csrf_field()}}
                                                              </form>
                                                              @endforeach
