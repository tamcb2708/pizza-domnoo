                            ...
                            ?>
                                                              ...
                                                              <form method="post" action="{{asset('admin/category/update-category/'.$cate->cate_id)}}" >
                                                                  <div class="form-group">
                                                                      ...
                                                                      <input required type="text"  name="name" class="form-control" placeholder="Điền Thông Tin..." value="{{$cate->cate_name}}">
                                                                  ...
                                                                  <input required type="submit"  name="submit" class="form-control btn btn-primary" placeholder="Ten danh muc..." value="Sửa">
                                                                   <div class="form-group">
                                                                      <a href="{{asset('admin/category')}}" class="form-control btn btn-danger">Quay Về Trang Trước</a>
                                                                  </div>
                                                                  {{csrf_field()}}
                                                              </form>
